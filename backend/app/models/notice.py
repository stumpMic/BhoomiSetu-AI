...
class Notice(Base):
    ...
    notice_type = Column(String(80), nullable=False, default="Section 4(1) Preliminary Notification")
    ...
    status = Column(String(30), nullable=False, default="Draft") # Draft, Published, Sent/Issued
