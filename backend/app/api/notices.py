...
def _format_notice_response(n: Notice) -> NoticeResponse:
    return NoticeResponse(
        ...
        notice_type=n.notice_type or "Section 4(1) Preliminary Notification",
        title=n.title,
...
def create_notice(
    ...
    n = Notice(
        ...
        notice_type=payload.notice_type or "Section 4(1) Preliminary Notification",
        title=payload.title,
...
def publish_notice(
    ...
    NotificationService.create_alert(
        ...
        message=f"{n.notice_type} '{n.title}' published for Case {n.case.case_number if n.case else 'Public Notice'}.",
