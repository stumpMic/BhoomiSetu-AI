...
export const Sidebar = () => {
  ...
  const navItems = [
    ...
    { to: '/survey/dashboard', label: 'Survey Operations', icon: Compass, roles: ['admin', 'survey_officer'] },
    { to: '/survey/requests', label: 'Survey Requests', icon: FileCheck, roles: ['admin', 'survey_officer'] },
    { to: '/compensation/work-queue', label: 'My Compensation Work', icon: CreditCard, roles: ['admin', 'compensation_officer'] },
    ...
    { to: '/compensation', label: t('nav.compensation'), icon: CreditCard, roles: ['admin', 'compensation_officer', 'land_acquisition_officer', 'landowner'] },
    ...
    { to: '/admin/verifications', label: 'User Verifications', icon: UserCheck, roles: ['admin'] },
